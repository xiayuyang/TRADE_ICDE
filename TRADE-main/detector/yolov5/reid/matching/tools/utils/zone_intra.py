...
class zone():
    def __init__(self, scene_name = 'S10'):
        # 0: b 1: g 3: r 123:w
        # w r 非高速
        # b g 高速
        zones = {}
        zone_path = opj("detector/yolov5/reid/matching/tools/zone", scene_name)
        for img_name in os.listdir(os.path.join(os.getcwd(), 
                                                'detector', 'yolov5', 'reid', 'matching', 'tools', 'zone', scene_name)):
